...
import {DropdownData, AddressDetails, User, CoreContacts, GridData} from "./adduser.model";
...
export class AddUserComponent implements OnInit {
    ...
    addAddressConfig;SaveConfig : SimpleButtonConfiguration;
    ...
    constructor(private _AddUserService :  AddUserService, private _commonsValidatorService : CommonsValidatorService) {
    ...
    directiveConfigClassCall(){
        ...
        this.phoneNoConfig = new NumberInputConfiguration(false,false,false,true,'10','10','Invalid Phone NO ');
        ...
        this.postalCodeConfig =  new NumberInputConfiguration(false,false,false,true,'','','Invalid postal Code ');
    ...
    saveUserData(){
        ...
        let componentArray = [this.phoneNoConfig,this.postalCodeConfig,this.sessionConfig,
