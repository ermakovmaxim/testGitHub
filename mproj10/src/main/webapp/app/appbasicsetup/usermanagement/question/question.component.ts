...
export class QuestionComponent {
	...
	constructor(  private questionService : QuestionService , private commonsValidatorService : CommonsValidatorService ) {
		...
		this.questionDetails = new TextAreaInputConfiguration(false,false,false,true,'','','Please enter Details');
		this.questionIcon = new TextInputConfiguration(false,false,false,true,'0','64','Please enter Icon');
