...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "3", comments = "Service for PhoneCommunication Transaction table", complexity = Complexity.MEDIUM)
...
public class PhoneCommunicationServiceImpl extends PhoneCommunicationService {
    ...
    public HttpEntity<ResponseBean> findPageWiseData(@RequestBody PaginationBean paginationBean) throws Exception {
        ...
        ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "PhoneCommunication"));
        responseBean.add("data", phoneCommunicationrepo.findPageWiseData("PhoneCommunication.findAll", paginationBean.getPageSize(), paginationBean.getPageNo()));
