...
public class LoginRepositoryImpl extends CommonUtilRepositoryImpl implements LoginRepository<Login> {
    ...
    public List<CommonEntityInterface> findPageWiseData(String jpqlQuery, int pageSize, int pageNo) throws Exception {
        ...
        Log.out.println("ABSUM324990200", runtimeLogInfoHelper.getRequestHeaderBean(), "LoginRepositoryImpl", "findPageWiseData", "Total Records Fetched = " + listOfCountry.size());
