...
export class AddressTypeComponent {
	...
	constructor(  private addressTypeService : AddressTypeService , private commonsValidatorService : CommonsValidatorService ) {
		...
		this.addressTypeDesc = new TextAreaInputConfiguration(false,false,false,true,'','','Please enter Address Type Desc');
		this.addressTypeIcon = new TextInputConfiguration(false,false,false,true,'0','128','Please enter Address Type Icon');
