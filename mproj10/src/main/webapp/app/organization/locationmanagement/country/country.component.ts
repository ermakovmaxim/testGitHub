...
import { TextInputConfiguration,DataGridConfiguration,NumberInputConfiguration,SimpleButtonConfiguration,CommonsValidatorService } from 'ng_custom_widgets';
...
export class CountryComponent {
	...
	constructor(  private countryService : CountryService , private commonsValidatorService : CommonsValidatorService ) {
		...
		this.countryCode1 = new TextInputConfiguration(false,false,false,true,'0','3','Please enter Code 1');
		this.countryCode2 = new TextInputConfiguration(false,false,false,true,'0','3','Please enter Code 2');
		this.countryFlag = new TextInputConfiguration(false,false,false,true,'0','64','Please enter Flag');
		this.capital = new TextInputConfiguration(false,false,false,true,'0','32','Please enter Capital');
		this.currencyCode = new TextInputConfiguration(false,false,false,true,'0','3','Please enter Currency Code');
		this.currencyName = new TextInputConfiguration(false,false,false,true,'0','128','Please enter Currency Name');
		this.currencySymbol = new TextInputConfiguration(false,false,false,true,'0','32','Please enter Currency Symbol');
		this.capitalLatitude = new NumberInputConfiguration(false,false,false,true,'0','11','Capital Latitude must be between 0 and 11');
		this.capitalLongitude = new NumberInputConfiguration(false,false,false,true,'0','11','Capital Longitude must be between 0 and 11');
		this.isoNumeric = new NumberInputConfiguration(false,false,false,true,'0','1000','ISO Numeric must be between 0 and 1000');
