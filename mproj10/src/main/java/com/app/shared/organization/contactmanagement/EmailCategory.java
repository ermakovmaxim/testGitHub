...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "3", comments = "EmailCategory", complexity = Complexity.LOW)
...
public class EmailCategory implements Serializable, CommonEntityInterface, Comparator<EmailCategory> {
    ...
    private static final long serialVersionUID = 1475492325313L;
