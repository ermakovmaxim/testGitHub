...
public class PasswordAlgoRepositoryImpl extends CommonUtilRepositoryImpl implements PasswordAlgoRepository<PasswordAlgo> {
    ...
    public List<CommonEntityInterface> findPageWiseData(String jpqlQuery, int pageSize, int pageNo) throws Exception {
        ...
        Log.out.println("ABSUM324990200", runtimeLogInfoHelper.getRequestHeaderBean(), "PasswordAlgoRepositoryImpl", "findPageWiseData", "Total Records Fetched = " + listOfCountry.size());
