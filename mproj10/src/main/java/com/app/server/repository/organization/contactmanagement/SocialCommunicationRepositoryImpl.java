...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "3", comments = "Repository for SocialCommunication Transaction table", complexity = Complexity.MEDIUM)
public class SocialCommunicationRepositoryImpl extends CommonUtilRepositoryImpl implements SocialCommunicationRepository<SocialCommunication> {
    ...
    public List<CommonEntityInterface> findPageWiseData(String jpqlQuery, int pageSize, int pageNo) throws Exception {
        ...
        Log.out.println("ORGCM324100200", runtimeLogInfoHelper.getRequestHeaderBean(), "SocialCommunicationRepositoryImpl", "findPageWiseData", "Total Records Fetched = " + listOfCountry.size());
