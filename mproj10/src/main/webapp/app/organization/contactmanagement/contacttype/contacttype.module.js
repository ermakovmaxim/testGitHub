...
var contacttype_service_1 = require('./contacttype.service');
var ContactTypeModule = (function () {
    function ContactTypeModule() {
    }
    ContactTypeModule = __decorate([
        core_1.NgModule({
            imports: [platform_browser_1.BrowserModule, forms_1.FormsModule, http_1.HttpModule, widget_shared_module_1.WidgetModule,
                router_1.RouterModule.forChild([{ path: '', component: contacttype_component_1.ContactTypeComponent }])
            ],
            declarations: [contacttype_component_1.ContactTypeComponent],
            providers: [contacttype_service_1.ContactTypeService]
        })
    ], ContactTypeModule);
    return ContactTypeModule;
}());
