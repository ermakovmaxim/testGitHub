...
var GroupFieldService = (function () {
    function GroupFieldService(_http) {
        this._http = _http;
    }
    GroupFieldService.prototype.getData = function (parentRef, callBackFunctionName, serviceUrl, methodType) {
        var _this = this;
    ...
    GroupFieldService.prototype.setData = function () {
        this.parentRef.setData(this.responseData);
    };
    GroupFieldService = __decorate([
        core_1.Injectable()
    ], GroupFieldService);
    return GroupFieldService;
}());
exports.GroupFieldService = GroupFieldService;
