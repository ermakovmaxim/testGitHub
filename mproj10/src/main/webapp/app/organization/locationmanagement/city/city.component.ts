...
export class CityComponent {
	...
	constructor(  private cityService : CityService , private commonsValidatorService : CommonsValidatorService ) {
		...
		this.cityDescription = new TextAreaInputConfiguration(false,false,false,true,'','','Please enter City Description');
		this.cityFlag = new TextInputConfiguration(false,false,false,true,'0','128','Please enter Flag');
		this.cityLatitude = new NumberInputConfiguration(false,false,false,true,'0','11','City Latitude must be between 0 and 11');
		this.cityLongitude = new NumberInputConfiguration(false,false,false,true,'0','11','City Longitude must be between 0 and 11');
