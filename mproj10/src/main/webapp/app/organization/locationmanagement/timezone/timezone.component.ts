...
export class TimezoneComponent {
	...
	constructor(  private timezoneService : TimezoneService , private commonsValidatorService : CommonsValidatorService ) {
		...
		this.gmtLabel = new TextInputConfiguration(false,false,false,true,'0','256','Please enter GMT');
		this.timeZoneLabel = new TextInputConfiguration(false,false,false,true,'0','256','Please enter Time Zone');
		this.country = new TextInputConfiguration(false,false,false,true,'0','256','Please enter Country');
		this.cities = new TextInputConfiguration(false,false,false,true,'0','256','Please enter City');
