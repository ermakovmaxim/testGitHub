...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "3", comments = "SocialCommunication", complexity = Complexity.LOW)
...
public class SocialCommunication implements Serializable, CommonEntityInterface, Comparator<SocialCommunication> {
    ...
    private static final long serialVersionUID = 1475492328685L;
