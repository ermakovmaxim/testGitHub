...
import { TextInputConfiguration,DataGridConfiguration,NumberInputConfiguration,SimpleButtonConfiguration,CommonsValidatorService,TextAreaInputConfiguration } from 'ng_custom_widgets';
...
export class LanguageComponent {
	...
	constructor(  private languageService : LanguageService , private commonsValidatorService : CommonsValidatorService ) {
		...
		this.languageType = new TextInputConfiguration(false,false,false,true,'0','32','Please enter Language Type');
		this.languageDescription = new TextAreaInputConfiguration(false,false,false,true,'','','Please enter Description');
		this.languageIcon = new TextInputConfiguration(false,false,false,true,'0','128','Please enter Icon');
		this.alpha2 = new TextInputConfiguration(false,false,false,true,'0','2','Please enter Alpha 2');
		this.alpha3 = new TextInputConfiguration(false,false,false,true,'0','3','Please enter Alpha 3');
		this.alpha4 = new TextInputConfiguration(false,false,false,true,'0','4','Please enter Alpha 4');
		this.alpha4parentid = new NumberInputConfiguration(false,false,false,true,'0','11','Aplha4 Parent Id must be between 0 and 11');
