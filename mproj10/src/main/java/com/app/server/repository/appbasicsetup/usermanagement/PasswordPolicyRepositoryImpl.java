...
public class PasswordPolicyRepositoryImpl extends CommonUtilRepositoryImpl implements PasswordPolicyRepository<PasswordPolicy> {
    ...
    public List<CommonEntityInterface> findPageWiseData(String jpqlQuery, int pageSize, int pageNo) throws Exception {
        ...
        Log.out.println("ABSUM324990200", runtimeLogInfoHelper.getRequestHeaderBean(), "PasswordPolicyRepositoryImpl", "findPageWiseData", "Total Records Fetched = " + listOfCountry.size());
