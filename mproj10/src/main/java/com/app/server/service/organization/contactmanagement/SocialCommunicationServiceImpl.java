...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "3", comments = "Service for SocialCommunication Transaction table", complexity = Complexity.MEDIUM)
...
public class SocialCommunicationServiceImpl extends SocialCommunicationService {
    ...
    public HttpEntity<ResponseBean> findPageWiseData(@RequestBody PaginationBean paginationBean) throws Exception {
        ...
        ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "SocialCommunication"));
        responseBean.add("data", socialCommunicationrepo.findPageWiseData("SocialCommunication.findAll", paginationBean.getPageSize(), paginationBean.getPageNo()));
