...
echo ' load incremental AST data starts....'
...
echo ' load incremental AST data ends....'
echo 'load Predefined AST data for Incremental DB starts....'
...
echo 'load Predefined AST data for Incremental DB ends....'
