...
var CUSTOM_INPUT_CONTROL_VALUE_ACCESSOR = new core_1.Provider(forms_2.NG_VALUE_ACCESSOR, {
    useExisting: core_1.forwardRef(function () { return PasswordInput; }),
    multi: true
});
var PasswordInput = (function () {
    ...
    PasswordInput.prototype.ngOnInit = function () {
        ...
        this.elementId = style_constants_1.PASSWORD_INPUT_PREFIX + Math.floor(Math.random() * 90000) + 10000;
        this.widgetConfig.elementId = this.elementId;
    };
    /**
     * Will remove attributes of pattern matching if null
     */
    PasswordInput.prototype.ngAfterViewInit = function () {
     ...
     * @param event
     */
    PasswordInput.prototype.validateInput = function (event) {
    ...
    Object.defineProperty(PasswordInput.prototype, "value", {
        //get accessor
    ...
    ;
    //Set touched on blur
    PasswordInput.prototype.onTouched = function (event) {
        this.validateInput(event);
        this._onTouchedCallback();
    };
    //From ControlValueAccessor interface
    PasswordInput.prototype.writeValue = function (value) {
        this._value = value;
    };
    //From ControlValueAccessor interface
    PasswordInput.prototype.registerOnChange = function (fn) {
        this._onChangeCallback = fn;
    };
    //From ControlValueAccessor interface
    PasswordInput.prototype.registerOnTouched = function (fn) {
        this._onTouchedCallback = fn;
    };
    __decorate([
        core_1.Input()
    ], PasswordInput.prototype, "label");
    __decorate([
        core_1.Input()
    ], PasswordInput.prototype, "regex");
    __decorate([
        core_1.Input()
    ], PasswordInput.prototype, "column");
    __decorate([
        core_1.Input()
    ], PasswordInput.prototype, "widgetConfig");
 ...
 */
var PasswordInputConfiguration = (function () {
    function PasswordInputConfiguration(hidden, disabled, readOnly, required, minLength, maxLength, errorMessage) {
        this.hidden = hidden;
...
exports.PasswordInputConfiguration = PasswordInputConfiguration;
