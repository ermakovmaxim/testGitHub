...
export class AddNewRoleComponent implements OnInit {
    ...
    deviceType : Object;
    constructor(private _roleFeatureService : RoleFeatureServices,private _commonsValidatorService : CommonsValidatorService) {
...
/*
    ...
    validateAndShowErrorMessages(componentConfigArray) {

        var invalidComponentsArray = [];
        componentConfigArray.forEach((componentConfig)=> {
            if(!componentConfig.validState) {
    ...
    getCombinedErrorMessage(invalidComponentsArray) {
