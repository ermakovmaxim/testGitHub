...
import { TextInputConfiguration,DataGridConfiguration,NumberInputConfiguration,SimpleButtonConfiguration,CommonsValidatorService,SelectInputConfiguration,TextAreaInputConfiguration } from 'ng_custom_widgets';
...
export class StateComponent {
	...
	constructor(  private stateService : StateService , private commonsValidatorService : CommonsValidatorService ) {
		...
		this.stateCode = new NumberInputConfiguration(false,false,false,true,'0','2','State Code must be between 0 and 2');
		this.stateCodeChar2 = new TextInputConfiguration(false,false,false,true,'0','32','Please enter State Code 2');
		this.stateCodeChar3 = new TextInputConfiguration(false,false,false,true,'0','32','Please enter State Code 3');
		this.stateDescription = new TextAreaInputConfiguration(false,false,false,true,'','','Please enter State Description');
		this.stateFlag = new TextInputConfiguration(false,false,false,true,'0','128','Please enter Flag');
		this.stateCapital = new TextInputConfiguration(false,false,false,true,'0','128','Please enter Capital');
		this.stateCapitalLatitude = new NumberInputConfiguration(false,false,false,true,'0','11','Capitial Latitude must be between 0 and 11');
		this.stateCapitalLongitude = new NumberInputConfiguration(false,false,false,true,'0','11','Capitial Longitude must be between 0 and 11');
