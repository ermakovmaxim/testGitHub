...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "Service for PhoneCategory Master table Entity", complexity = Complexity.LOW)
...
public class PhoneCategoryServiceImpl extends PhoneCategoryService {
    ...
    public HttpEntity<ResponseBean> findPageWiseData(@RequestBody PaginationBean paginationBean) throws Exception {
        ...
        ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "PhoneCategory"));
        responseBean.add("data", phoneCategoryrepo.findPageWiseData("PhoneCategory.findAll", paginationBean.getPageSize(), paginationBean.getPageNo()));
