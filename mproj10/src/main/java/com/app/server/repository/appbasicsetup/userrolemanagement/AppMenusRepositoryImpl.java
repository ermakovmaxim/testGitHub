...
public class AppMenusRepositoryImpl extends CommonUtilRepositoryImpl implements AppMenusRepository<AppMenus> {
    ...
    public List<CommonEntityInterface> findPageWiseData(String jpqlQuery, int pageSize, int pageNo) throws Exception {
        ...
        Log.out.println("ABSRM324990200", runtimeLogInfoHelper.getRequestHeaderBean(), "AppMenusRepositoryImpl", "findPageWiseData", "Total Records Fetched = " + listOfCountry.size());
