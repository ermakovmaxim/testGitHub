...
public class AddressRepositoryImpl extends CommonUtilRepositoryImpl implements AddressRepository<Address> {
    ...
    public List<CommonEntityInterface> findPageWiseData(String jpqlQuery, int pageSize, int pageNo) throws Exception {
        ...
        Log.out.println("ORGLM324990200", runtimeLogInfoHelper.getRequestHeaderBean(), "AddressRepositoryImpl", "findPageWiseData", "Total Records Fetched = " + listOfCountry.size());
