...
var userrolemapping_component_1 = require("./userrolemapping.component");
var userrolemapping_service_1 = require("./userrolemapping.service");
var widget_shared_module_1 = require("../../../components/widget.shared.module");
var UserRoleMappingModule = (function () {
        ...
        core_1.NgModule({
            imports: [platform_browser_1.BrowserModule, router_1.RouterModule, forms_1.FormsModule, http_1.HttpModule, widget_shared_module_1.WidgetModule,
                router_1.RouterModule.forChild([
                    { path: '', component: userrolemapping_component_1.UserRoleMappingComponent }
                ])
            ],
            providers: [userrolemapping_service_1.UserRoleService],
            declarations: [userrolemapping_component_1.UserRoleMappingComponent]
        })
