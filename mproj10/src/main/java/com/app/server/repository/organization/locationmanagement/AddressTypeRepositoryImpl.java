...
public class AddressTypeRepositoryImpl extends CommonUtilRepositoryImpl implements AddressTypeRepository<AddressType> {
    ...
    public List<CommonEntityInterface> findPageWiseData(String jpqlQuery, int pageSize, int pageNo) throws Exception {
        ...
        Log.out.println("ORGLM324990200", runtimeLogInfoHelper.getRequestHeaderBean(), "AddressTypeRepositoryImpl", "findPageWiseData", "Total Records Fetched = " + listOfCountry.size());
