...
import { TextInputConfiguration,DataGridConfiguration,SimpleButtonConfiguration,CommonsValidatorService,TextAreaInputConfiguration } from 'ng_custom_widgets';
...
export class ContactTypeComponent {
	...
	constructor(  private contactTypeService : ContactTypeService , private commonsValidatorService : CommonsValidatorService ) {
		...
		this.contactTypeDesc = new TextAreaInputConfiguration(false,false,false,true,'','','Please enter Contact Type Description');
		this.contactTypeIcon = new TextInputConfiguration(false,false,false,true,'0','128','Please enter Contact Type Icon');
