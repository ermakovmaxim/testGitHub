...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "3", comments = "Repository for UserDetail Transaction table", complexity = Complexity.MEDIUM)
